 ...
 */
export function renderGantt(tasks, criticalPath, title, totalHours, t0, durationHours, criticalTimespanHours) {
    let d0;
    if (t0) {
        d0 = new Date(t0);
    }
 ...
 */
export function renderSimpleGantt(tasks, totalHours, title, t0) {
    let d0;
    if (t0) {
        d0 = new Date(t0);
    }

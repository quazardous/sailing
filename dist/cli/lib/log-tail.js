 ...
 */
export function showRecentTextLog(logFile, lines = 20) {
 ...
 */
export function createTextLogTailer(logFile) {
 ...
 */
export function showRecentJsonLog(jsonLogFile, lines = 20, processor, rawOutput = false) {
 ...
 * @param rawOutput - If true, output raw JSON lines without processing
 */
export function createJsonLogTailer(jsonLogFile, processor, rawOutput = false) {

...
import { CONDUCTOR_TOOLS, handleConductorTool, formatToolHelp, getToolSchema } from '../managers/mcp-tools-manager/index.js';
...
// Commands
// =============================================================================
export function registerMcpConductorCommands(program) {

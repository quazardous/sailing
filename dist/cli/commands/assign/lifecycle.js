...
import { findTaskFile, detectEntityType, isRunning, removeRunFile, logToTask, assignmentPath, handleTaskClaim, handleEpicClaim, handlePrdClaim } from './helpers.js';
/**
 * Register assignment lifecycle commands
 */
export function registerLifecycleCommands(assign) {

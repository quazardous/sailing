...
import os from 'os';
import { findProjectRoot, loadPathsConfig, getTemplates, getPrompting, isDevInstall, getRepoRoot, resolvePlaceholders, resolvePath, getPath, getPathType } from './core-manager.js';
 ...
 */
export function getConfigInfo(scriptDir) {

 ...
 */
function archivePrdIdFromDir(prdDir) {
 ...
 */
function scanArtefactDir(dir, prefix, type, prdId, index) {
    ...
    for (const file of files) {
        ...
        index.set(`${prefix}:${numKey}`, {
            ...
            parent: loaded?.data?.parent || prdId,
            prdId,
            file: filePath,
 ...
 */
function scanPrdFile(prdDir, prdId, index) {
 ...
 */
export function getArchivedArtefact(id) {
 ...
 */
export function getAllArchivedTasks(options = {}) {
    return filterArchive('task', options);
}
/**
 * Get all archived epics
 */
export function getAllArchivedEpics(options = {}) {
    return filterArchive('epic', options);
}
/**
 * Get all archived PRDs
 */
export function getAllArchivedPrds() {
    return filterArchive('prd', {});
}
function filterArchive(type, options) {
    const index = buildArchiveIndex();

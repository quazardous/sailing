/**
 * MCP Agent Debug Commands
 *
 * Debug CLI for testing MCP agent tools (limited sandbox access).
 *
 * Commands:
 * - mcp-agent:tools  List available tools
...
export function registerMcpAgentCommands(program: Command) {

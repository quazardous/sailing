...
const VALID_STATUSES = ['completed', 'failed', 'blocked'];
const VALID_LOG_LEVELS = ['info', 'tip', 'warn', 'error', 'critical'];
const VALID_FILE_ACTIONS = ['created', 'modified', 'deleted'];
const VALID_ISSUE_TYPES = ['blocker', 'question', 'concern'];
  ...
  if (result.issues !== undefined) {
    if (!Array.isArray(result.issues)) {
      ...
      result.issues.forEach((issue, i) => {
        ...
        } else if (!VALID_ISSUE_TYPES.includes(issue.type)) {

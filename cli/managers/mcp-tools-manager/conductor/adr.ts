...
export const ADR_TOOLS: ToolDefinition[] = [
  {
    tool: {
      name: 'adr_list',
  ...
  },
  {
    ...
    handler: (args) => {
      ...
      try {
        const success = updateAdrStatus(id, newStatus as AdrStatus, { supersededBy });
  ...
  },
  {
    ...
    handler: (args) => {
      ...
      try {
        ...
        const lines: string[] = ['## Architecture Decision Records (ADRs)', ''];

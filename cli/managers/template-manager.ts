...
import { getSailingRepoRoot, isDevInstall, getPath } from './core-manager.js';
...
/**
 * Variable definition from template header
 */
 ...
 *   #}
 */
export function parseTemplateHeader(content: string): TemplateVariable[] {

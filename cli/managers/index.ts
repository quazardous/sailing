...
export {
  ...
  escalateEpicToInProgress,
  escalatePrdToInProgress,
  checkAndUpdateEpicAutoDone,
  checkAndUpdatePrdAutoDone
} from './status-manager.js';
export type { StatusTransitionResult, CascadeResult } from './status-manager.js';
